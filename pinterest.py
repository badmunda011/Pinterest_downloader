...
LOG = os.environ.get("LOG", "-1002093247039")
OWNER = os.environ.get("OWNER", "Farooq_is_KING")
SUPPORT_CHAT = os.environ.get("SUPPORT_CHAT", "https://t.me/WD_Topic_Group")
...
мα∂є ωιтн 🖤 ву: [𝐖𝐎𝐎𝐃𝐜𝐫𝐚𝐟𝐭⁮](tg://user?id=5827766615) ...!!
"""
        ...
        markup = bot.build_reply_markup(
            [
                [
                    ...
                    Button.url(text="🥀ᴅᴇᴠᴇʟᴏᴘᴇʀ🥀", url="WD_Contact_Bot.t.me"),
                ],
    ...
    try:
        ...
        if url:
            ...
            await event.client.send_file(
                ...
                j,
                thumb=thumb,
                caption="♡︎ тнαик уσυ fσя υѕιиg мє. \n\n» ᴀ ᴘɪɴᴛᴇʀᴇsᴛ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ ʙᴏᴛ ʙʏ [❖ 𝐖𝐃 𝐙𝐎𝐍𝐄 ❖ ™](https://Opleech.t.me)",
...
async def otherbots(event):
    ...
    await event.edit(
        "**➻ σтнєя вσтѕ:**\n\n"
        + "๏ [𝐒𝐩𝐨𝐭𝐢𝐟𝐲 𝐌𝐮𝐬𝐢𝐜 🦋 ♪](t.me/Spotify_Pro_v1_bot)\n"
        + "๏ [String Generator](t.me/StringGenerator_V2_Bot)\n"
        + "[✭ ᴍᴏʀᴇ ʙᴏᴛs ᴄᴏᴍɪɴɢ sᴏᴏɴ](t.me/WD_Topic_Group)\n",
        buttons=markup,
        link_preview=False,
    )
